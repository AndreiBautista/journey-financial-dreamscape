...
const InsuranceOptimization = ({
  ...
  useEffect(() => {
    if (hasBundle) {
      const totalPremium = lowDeductible ? currentAutoPremium + currentHomePremium : higherAutoPremium + higherHomePremium;
  ...
  }, [hasBoatInsurance, katieLifeInsurance, recommendedLifeInsurance, readyForHigherDeductibles, lowDeductible, totalAnnualSavings, umbrellaRecommended, hasUmbrellaPolicy, hasHSA, healthDeductible, hasBundle, annualBundleSavings]);
  ...
  return <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            {insuranceRecommendations.length > 0 ? <ul className="space-y-4">
                {insuranceRecommendations.map((recommendation, index) => <li key={index} className="flex items-start gap-2">
                    <InfoIcon className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <span>{recommendation}</span>
                  </li>)}
              </ul> : <div className="flex items-center justify-center h-32 text-gray-500">
                <p>Your insurance coverage is optimized!</p>
              </div>}
            
            <Button onClick={optimizeInsurance} className="w-full mt-6 bg-blue-600 hover:bg-blue-700">
              ...
              <CardContent className="space-y-6">
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <Select value={autoInsuranceType} onValueChange={setAutoInsuranceType}>
                ...
                <div className="flex items-center space-x-2">
                  <Switch id="lowAutoDeductible" checked={lowDeductible} onCheckedChange={setLowDeductible} disabled={!readyForHigherDeductibles} />
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="currentDeductible" type="number" value={currentAutoDeductible} onChange={e => setCurrentAutoDeductible(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="currentPremium">
                      {lowDeductible ? "Current Annual Premium" : "Previous Annual Premium"}
                    </Label>
                    <Input id="currentPremium" type="number" value={currentAutoPremium} onChange={e => setCurrentAutoPremium(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="higherDeductible">
                      {lowDeductible ? "Higher Deductible Option" : "Current Deductible"}
                    </Label>
                    <Input id="higherDeductible" type="number" value={higherAutoDeductible} onChange={e => setHigherAutoDeductible(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="higherPremium">
                      {lowDeductible ? "Higher Deductible Premium" : "Current Annual Premium"}
                    </Label>
                    <Input id="higherPremium" type="number" value={higherAutoPremium} onChange={e => setHigherAutoPremium(Number(e.target.value))} />
                  </div>
                </div>
                
                {lowDeductible && autoSavings > 0 && <Alert className="bg-blue-50 border-blue-200">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="currentHomeDeductible" type="number" value={currentHomeDeductible} onChange={e => setCurrentHomeDeductible(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="currentHomePremium">
                      {lowDeductible ? "Current Annual Premium" : "Previous Annual Premium"}
                    </Label>
                    <Input id="currentHomePremium" type="number" value={currentHomePremium} onChange={e => setCurrentHomePremium(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="higherHomeDeductible">
                      {lowDeductible ? "Higher Deductible Option" : "Current Deductible"}
                    </Label>
                    <Input id="higherHomeDeductible" type="number" value={higherHomeDeductible} onChange={e => setHigherHomeDeductible(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="higherHomePremium">
                      {lowDeductible ? "Higher Deductible Premium" : "Current Annual Premium"}
                    </Label>
                    <Input id="higherHomePremium" type="number" value={higherHomePremium} onChange={e => setHigherHomePremium(Number(e.target.value))} />
                  </div>
                </div>
                
                {lowDeductible && homeSavings > 0 && <Alert className="bg-blue-50 border-blue-200">
                    <InfoIcon className="h-4 w-4 text-blue-500" />
                    <AlertTitle>Potential Annual Savings</AlertTitle>
                    <AlertDescription>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="healthDeductible" type="number" value={healthDeductible} onChange={e => setHealthDeductible(Number(e.target.value))} />
                  </div>
                  <div>
                    <Label htmlFor="healthPremium">Annual Premium</Label>
                    <Input id="healthPremium" type="number" value={healthPremium} onChange={e => setHealthPremium(Number(e.target.value))} />
                  </div>
                </div>
                
                <div className="flex items-center space-x-2">
                  <Switch id="hasHsa" checked={hasHSA} onCheckedChange={setHasHSA} />
                  <Label htmlFor="hasHsa">Health Savings Account (HSA)</Label>
                </div>
                
                {hasHSA && <div>
                    <Label htmlFor="hsaContribution">Annual HSA Contribution</Label>
                    <Input id="hsaContribution" type="number" value={hsaContribution} onChange={e => setHsaContribution(Number(e.target.value))} />
                    <span className="text-xs text-muted-foreground">Max for individual: $3,850 | Family: $7,750</span>
                  </div>}
                
                {healthDeductible > 1500 && !hasHSA && <Alert>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input id="katieLife" type="number" value={katieLifeInsurance} onChange={e => setKatieLifeInsurance(Number(e.target.value))} />
                  ...
                  <div>
                    ...
                    <Input id="chadLife" type="number" value={chadLifeInsurance} onChange={e => setChadLifeInsurance(Number(e.target.value))} />
                  </div>
                </div>
                
                {katieLifeInsurance < recommendedLifeInsurance && <Alert>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4 pb-6 border-b">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="boatInsurance" checked={hasBoatInsurance} onCheckedChange={checked => {
                  ...
                  {hasBoatInsurance ? <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="boatValue">Boat Value</Label>
                        <Input id="boatValue" type="number" value={boatValue} onChange={e => {
                      ...
                      <div>
                        ...
                        <Input id="boatPremium" type="number" value={boatInsurancePremium} onChange={e => setBoatInsurancePremium(Number(e.target.value))} />
                      </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="umbrellaPolicy" checked={hasUmbrellaPolicy} onCheckedChange={setHasUmbrellaPolicy} />
                  </div>
                  
                  {hasUmbrellaPolicy ? <div>
                      <Label htmlFor="umbrellaPremium">Annual Premium</Label>
                      <Input id="umbrellaPremium" type="number" value={umbrellaPremium} onChange={e => setUmbrellaPremium(Number(e.target.value))} />
                    </div> : umbrellaRecommended && <Alert>
                        <InfoIcon className="h-4 w-4" />
                ...
                <div className="space-y-4 pt-4 border-t">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch id="bundleInsurance" checked={hasBundle} onCheckedChange={setHasBundle} />
                  </div>
                  ...
                  {hasBundle ? <div>
                      ...
                      <div className="mt-3">
                        ...
                        <Input id="bundleDiscountRate" type="number" min="0" max="30" value={Math.round(bundleDiscount * 100)} onChange={e => setBundleDiscount(Number(e.target.value) / 100)} />
